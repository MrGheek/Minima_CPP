...
tutorial::tutorial()
    : Command("tutorial", "Show the complete Grammar for Minima KISSVM scripting") {
}

std::unique_ptr<JSONObject> tutorial::runCommand() { 
...
Command* tutorial::getFunction() { // Change return type
    return new tutorial(); // Return a raw pointer
}
